...
int cardEffectBaron(struct gameState*,int,int);
int cardEffectMinion(struct gameState*,int,int,int,int);
int cardEffectMine(struct gameState*,int,int,int,int);
int cardEffectTribute(struct gameState*,int,int);
int cardEffectAmbassador(struct gameState*,int,int,int,int);

    int cardEffectBaron(struct gameState *state, int choice1, int currentPlayer)
    {
...
//printf("card is victory\n");
    ...
    int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
    {
      ...
      switch( card )
      {
        ...
        case mine:
        return cardEffectMine(state,choice1,choice2,currentPlayer,handPos);
        ...
        case baron:
        return cardEffectBaron(state,choice1,currentPlayer);
        ...
        case minion:
        return cardEffectMinion(state,choice1,choice2,currentPlayer,handPos);
        ...
        case tribute:
        return cardEffectTribute(state,currentPlayer,nextPlayer);

        case ambassador:
        return cardEffectAmbassador(state,choice1,choice2,currentPlayer,handPos);
